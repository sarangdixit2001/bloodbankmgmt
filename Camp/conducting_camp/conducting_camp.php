...
<head>
    ...
    <title>Conduting Camp</title>
    <link rel="stylesheet" href="../../css/style.css">
    <link rel="stylesheet" href="../conducting_camp/conducting_camp.css">
...
<body>
    ...
    <div>
        <strong class="strng">Nashik Blood bank organizes blood donation camps with the following mutual understanding with the Organizers:</strong>
    </div>
    <div id="img">
        <img src="../../img/conducting_camp1" alt="" srcset="">
    </div>
    <div>
        <h2 class="heading">
    ...
    <div class="blood_img">
        <img src="../../img/conducting_camp2.png" alt="" srcset="">
    </div>
