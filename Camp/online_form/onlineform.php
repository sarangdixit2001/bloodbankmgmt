...
if (isset($_POST['submit'])) {
    ...
    $date_reservation = mysqli_real_escape_string($con, $_POST['date_reservation']);



    $insert = "INSERT INTO online_form(name, organisation, email,mobile_no, date_reservation) values('$name','$organisation','$email','$mobile_no','$date_reservation')";

    $query = mysqli_query($con, $insert);

    if ($query) {
        echo '<script>alert("Your Blood Doantion Camp Booking Form is Submitted Sucessfully.")</script>';
        header("refresh:1 ; url=../online_form/onlineform.php");
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="../online_form/onlineform.css">
...
<body>
    ...
    <div class="contanier">
        <form class="myform" action="../online_form/onlineform.php" method="POST">
            ...
            <label for="yorgan" class="tlabel">Your Organisation</label><br>
            <input class="myinput" type="text" name="organisation" id="yorgan" required="required" placeholder="Your Organisation" /><br>
            ...
            <label class="res" for="yreservation">Date of Camp Reservation</label><br>
            <input class="don" type="date"  name="date_reservation" id="yreservation" required pattern="\d{4}-\d{2}-\d{2}" required="required" placeholder="Date of Camp Reservation" /><br><br>


            <div class="press">
                <button class="btn1" name="submit">Book Now </button>
            </div>
