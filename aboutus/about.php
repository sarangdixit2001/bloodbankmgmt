...
<head>
    ...
    <link rel="stylesheet" href="../aboutus/about.css">
...
<body>
    ...
    <div>
        <h2 class="heading">About Blood Bank</h2>
    </div>

    <div>
        <p class="paragraph">
            We at Nashik Blood Centre ensures easily accessible and adequate supply of safest & Superior<br> quality blood & blood components collected and procured from a voluntary non- remunerated<br> regular blood donor in well equipped premises,which is almost free from infections, and is stored<br> and transported under optimum conditions and is issued at ‘not-for-profit ‘ charges NASHIK always<br> ready to help any deserving person as per its policy,”No patients should suffer for want of blood<br><br><br><br>Besides providing safe and tested whole blood for transfusion to patients, the following components <br>are also made available with the help of a Cell Separator:
        </p>


    </div>
    <div id="img">
        <img src="../img/headingimg.png" alt="">
        <h2 id="heading2" class="heading1">BLOOD DONORS ARE QUIET HEROES!</h2>
    </div>
    <hr>

    <div id="bloodtheropy">
        <img src="../img/Screenshot 2022-05-13 223515.png" alt="">
    </div>
    <hr>

    <div id="bloodtheropy">
        <img src="../img/Screenshot technology.png" alt="">
    </div>

    <div id="bloodtherop">
        <img src="../img/Screenshot electra.png" alt="">
    </div>
