...
<head>
    ...
    <title>Thalassemia Program</title>
    <link rel="stylesheet" href="../../css/style.css">
    <link rel="stylesheet" href="../../aboutus/thalassemia program/thalassemia.css">
    <!-- CSS only -->
...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="../activities/activities.php">Activities</a></li>
                            <li><a class="dropdown-item" href="../thalassemia program/thalassemia.php">Thalassemia Program</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div id="img">
        <img src="../../img/thalassemia1.png" alt="">
        <img src="../../img/thalassemia2.png" alt="">
    </div>
    ...
    <div>
        <ul class="listing">
            <li>Create awareness – The best way to lower the incidence of thalassemia is to increase awareness about the disease.</li>

            <li>Perform a simple screening test to ascertain if you are a carrier – a blood test hamogram can be done on an automated Haematology Analyzer. A Confirmatory Test performing Haemoglobin Chromatography on Variant HPLC system confirms suspected cases.</li>

            <li>Adopt a thalassemic child – Most thalassemics die unattended by the age of 3 to 4 years. Do not let an innocent child be deprived of the hope to live. All you need to do for saving a precious life is to contribute a small amount of money and adopt a thalassemic child.</li>
