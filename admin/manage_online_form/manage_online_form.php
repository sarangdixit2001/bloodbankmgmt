...
<head>
    ...
    <link rel="stylesheet" href="../manage_online_form/manage_online_form.css">
...
<body class="bg-light" id="regiuser">
    <div class="container bg-dark text-light p-3 rounded my-4">
        <div class="d-flex align-items-center justify-content-between">
            <h2><i class="bi bi-bag-check"></i> Online_Form</h2>
        </div>
    </div>
    <?php
		...
		<table class="table table-hover text-center">
			<thead class="bg-dark text-light">
				<tr>
					...
					<th width="10%" scope="col">organisation</th>
					<th width="10%" scope="col">email</th>
					<th width="10%" scope="col">mobile_no</th>
					<th width="10%" scope="col">date_reservation</th>
			...
			<tbody class="bg-white">
				...
				while ($fetch = mysqli_fetch_assoc($result)) {
					...
					echo <<<product
								...
								<th scope="row">$i</th>
								<td>$fetch[name]</td>
								<td>$fetch[organisation]</td>
								<td>$fetch[email]</td>
								<td>$fetch[mobile_no]</td>
								<td>$fetch[date_reservation]</td><td>
