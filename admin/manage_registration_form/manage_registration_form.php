...
<head>
    ...
    <link rel="stylesheet" href="../manage_registration_form/manage_registration_form.css">
...
<body class="bg-light" id="regiuser">
    <div class="container bg-dark text-light p-3 rounded my-4">
        <div class="d-flex align-items-center justify-content-between">
            <h2><i class="bi bi-bag-check"></i> Registration_Form</h2>
        </div>
    </div>
    <?php
		...
		<table class="table table-hover text-center">
			<thead class="bg-dark text-light">
				<tr>
					...
					<th width="10%" scope="col">pincode</th>
					<th width="10%" scope="col">date</th>
					<th width="10%" scope="col">mobile_no</th>
					<th width="10%" scope="col">email</th>
					<th width="10%" scope="col">Blood_grp</th>
					<th width="10%" scope="col">check_value</th>
					<th width="10%" scope="col">Last_date_of_donate_blood</th>
			...
			<tbody class="bg-white">
				...
				$query = "SELECT * FROM `self_registration_form`";
				...
				while ($fetch = mysqli_fetch_assoc($result)) {
					...
					echo <<<product
								...
								<td>$fetch[email]</td>
								<td>$fetch[Blood_grp]</td>
								<td>$fetch[check_value]</td>
								<td>$fetch[Last_date_of_donate_blood]</td><td>
