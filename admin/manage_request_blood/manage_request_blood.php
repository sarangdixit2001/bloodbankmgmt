...
<head>
    ...
    <link rel="stylesheet" href="../manage_request_blood/manage_request_blood.css">
...
<body class="bg-light" id="regiuser">
    <div class="container bg-dark text-light p-3 rounded my-4">
        <div class="d-flex align-items-center justify-content-between">
            <h2><i class="bi bi-bag-check"></i> Blood Request Manager</h2>
        </div>
    </div>
    <?php
		...
		<table class="table table-hover text-center">
			<thead class="bg-dark text-light">
				<tr>
					...
					<th width="10%" scope="col">dname</th>
					<th width="10%" scope="col">mobile_no</th>
					<th width="10%" scope="col">email</th>
					<th width="10%" scope="col">date</th>
					<th width="10%" scope="col">Amt_Blood_Need</th>
