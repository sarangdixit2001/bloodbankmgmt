...
<body>
    ...
    <div>
        <strong id="strong">Most people can give blood. You can give blood if you:</strong>
    </div>

    <div id="list">
        <li>Are fit and healthy</li>
        <li>Weight over 7 stone 12 lbs or 50kg.</li>
    ...
    <div id="img">
        <img src="../../img/blood-types.gif" alt="">
    </div>

    <div>
        <strong id="strong">How often can I give blood?</strong>
        <p id="list">Men can give blood every 12 weeks and women can give blood every 16 weeks.</p>
    </div>

    <div>
        <strong id="strong">Check you are able to give blood</strong>
        <p id="list">If you have an existing medical condition or have a question about your eligibility to give blood you should check the health and travel<br>section before you book an appointment.

            <br><br>Common eligibility questions include:
        </p>
        <div id="list">
        <ul>
        <li>1.Receiving treatment.</li>
        <li>2.Taking medication</li>
        <li>3.Tattoos.</li>
        <li>4.Pregnancy</li>
        <li>5.Illness</li>
        <li>6.Cancer</li>
        <li>7.Received blood, blood products or organs</li>
</ul>
        </div>
    </div>
    ...
    <div id="list">
        <li>1  .A Whole Blood Donor Can Donate As Frequently As 90 Days. A Benefits From This Often Is That You Receive A Miniphysical Examination.</li>
        <li>2  .Statistics Show That 25, Or More Of Us Will Require Blood At Least Once In Our Life Time.</li>
        <li>3.  Men Who Participate In Blood Donation Experience 30, Lower Incident Of Heart Disease And Stroke.</li>
        <li>4. Blood Donation Can Reduce The Overall Iron Levels Which May Protect From Heart Disease.</li>
        <li>5.  Blood Donations Force Yam Body To Replace The Lost Blood With Fresh New Cells.</li>
        <li>6.  Voluntary Blood Donation Is Not Only A Confidential And Free Mean By Which HIV. HBsAg. HCV. VDRL, Mala. Testing Can Be Done, But Also Offers Testing In A Society Acceptable And Stigmatizing Setting.</li>
        <li>7.  When You Donate One Unit Of Blood Our Body Bums 650 Calories. So It Keeps You Fit And Prevent Obesity And Complications.</li>
        <li>8.  There Is Lower Incidence Of Coronary Heart Diseases And Obesity In Blood Donors. As It Lowers The Cholesterol And Other Lipids.</li>
        <li>9.  It Has Been Found That Elderly People In Good Health Have Reported Feeling Invigorated And Reenegised By Giving Blood On Regular Basis.</li>
        <li>10.  As An Individual Donates More Frequently Anxiety Decreases And Positive Feelings Increase And Sell Commitment Devolves. So It Adds To One’s Sell Esteem And General Well Being.</li>
    </div>
